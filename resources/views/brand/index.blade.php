...
<div class="card">
    <div class="card-header">
        <h4 style="color:#4B49AC;"><b>Brand Management</b><a href="#" style="margin-left: 93%;
            ...
            <form class="forms-sample" action="{{ route('brand.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="title" id="title" class="form-control" id="exampleInputUsername2" placeholder="Please Enter Brand Name" name="title">
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.editUnit', function() {
        ...
        $.get("{{ url('brand') }}" + '/' + 'edit/' + food_id, function(
            data) {
