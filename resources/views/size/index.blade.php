...
<div class="card">
    <div class="card-header">
        <h4 style="color:#4B49AC;"><b>Size Management</b><a href="#" style="margin-left: 93%;
            ...
            <form class="forms-sample" action="{{ route('size.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="title" class="form-control" id="exampleInputUsername2" placeholder="Please Enter Size" name="title" required>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.editUnit', function() {
        ...
        $.get("{{ url('size') }}" + '/' + 'edit/' + food_id, function(
            data) {
